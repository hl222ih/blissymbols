BLISS_WORD_DATA = {
	"words": {
		...
		"cycle_of_life,life_cycle": ["rotation,circulation,orbit,lap,circle,round","life"],
		...
		"dance,dancing": ["legs_and_feet","musical_note,music_(in_combinations)"],
		...
		"democracy": ["permission,allowance","choice,selection,election"],
		"democracy_(state)": ["country,state","permission,allowance","choice,selection,election"],
		...
		"dental_floss": ["fiber,fibre,fibril,filament,strand","teeth"],
		...
		"diagnosis_(medical)": ["outcome,result","evaluation,value","medicine,medical_practice"],
		...
		"dictionary,lexicon,wordbook": ["book","word"],
		...
		"different,other,unequal": ["different,other,difference","indicator_(description)"],
		...
		"digital_game,video_game,computer_game": ["play,game_(in_combinations)","digits_(computer)"],
		...
		"disappointed": ["disappointment","indicator_(description_after_fact)"],
		"disappointing": ["disappointment","indicator_(description)"],
		"disappointment": ["sadness,sorrow,unhappiness","after,behind","wish,desire"],
		...
		"disgusting_(general)": ["awful,dreadful,terrible","intensity"],
		"disgusting_(taste)": ["tasteless,not_tasty,not_good","intensity"],
		...
		"district,area,neighbourhood_(country)": ["part,bit,piece,portion,part_of","countryside,country,nature"],
		"district,city_district,neighbourhood_(town)": ["part,bit,piece,portion,part_of","town,city_(small)"],
		"diver_(active_under_water)": ["person,human_being,individual,human","diving,activity_under_water"],
		"diver_(jump)": ["person,human_being,individual,human","diving_(sport)"],
		"diversity,variety_(general)": ["group_of,much_of,many_of,quantity_of","different,other,difference"],
		"divide-(to)": ["division","indicator_(action)"],
		"divided": ["division","indicator_(description)"],
		"divine,holy": ["God","indicator_(description)"],
		"diving,activity_under_water": ["activity,male_gender_(in_combinations)","under,below,inferior","puddle,pool,water_(ground_level)"],
		"diving_(sport)": ["sport","jump","puddle,pool,water_(ground_level)"],
		...
		"domino": ["play,game_(in_combinations)","tile"],
		...
		"download": ["getting,acquiring,receiving","digits_(computer)"],
		"download-(to)": ["download","indicator_(action)"],
		"dragon": ["animal,beast","fire"],
		...
		"drying_rack": ["structure,construction","dryness,drought"],
		"drying_rack_(cloth)": ["drying_rack","cloth,fabric,material,textile,net"],
		"drying_rack_(fish)": ["drying_rack","fish_(animal)"],
		...
		"dyscalculia": ["limit(s),limitation,restriction","number"],
		"dysgraphia": ["limit(s),limitation,restriction","pen,pencil"],
		"dyslexia": ["limit(s),limitation,restriction","reading"],
		"dystonia": ["activity,male_gender_(in_combinations)","muscle","up_and_down"],
		"e-book,digital_book": ["book","digits_(computer)"],
		...
		"ear_bone,ossicle,auditory_ossicle": ["bone","ear"],
		"eardrum,tympanic_membrane": ["membrane,drumhead,drum_skin","ear"],
		"eardrum,tympanic_membrane": ["membrane,drumhead,drum_skin","ear"],
		...
		"egg_white,white_of_egg,albumin,glair": ["egg,ovum_(2)","white"],
		"egg_yolk,yolk": ["egg,ovum_(2)","yellow_(bci)"],
		"eggplant": ["vegetable_(oval-shaped)","purple,violet_(bci)"],
		"eggshell": ["shell,crust","egg,ovum_(2)"],
		...
		"electricity_meter": ["gauge,gage,meter","electricity"],
		...
		"endlessness": ["minus,no,without","end,arrival,stop"],
		...
		"equality_(social)": ["same,equal,equality","society"],
		...
		"excellence": ["correctness,rightness","intensity"],
		...
		"exercise,work_out-(to)": ["exercise_(physical)","indicator_(action)"],
		"exercise_(physical)": ["work,employment,job","health"],
		"exhausted,worn_out": ["feeling,emotion,sensation","indicator_(description)","minus,no,without","energy_(mental)"],
		...
		"face_painting": ["picture,image,icon,painting","face","brush"],
		...
		"faint,pass_out-(to)": ["fainting,absence","indicator_(action)"],
		"fainting,absence": ["mind,intellect,reason","minus,no,without","activity,male_gender_(in_combinations)","limited_time,interval,period,awhile,for_a_while"],
		...
		"far,distant,remote": ["farness,remoteness,farawayness","indicator_(description)"],
		...
		"fear_of_heights,acrophobia": ["fear,fright,concern","height,tallness"],
		...
		"finished,complete,completed,done,all_done": ["active,actively","all,every,everything,total,whole"],
		...
		"fishing": ["getting,acquiring,receiving","fish_(animal)"],
		"fishing_(sport)": ["sport","fishing"],
		"fishing_line": ["fiber,fibre,fibril,filament,strand","fishing"],
		"fishing_rod": ["linear_thing,pole","fishing"],
		"fishnet": ["cloth,fabric,material,textile,net","fish_(animal)"],
		"fist": ["hand","fold,folding,pleating"],
		...
		"flight_attendant": ["worker","airplane,aeroplane,plane"],
		"flight_deck,cockpit": ["room","pilot"],
		"flight_instrument(s)": ["gauge,gage,meter","airplane,aeroplane,plane"],
		"float-(to)": ["floating_container","indicator_(action)"],
		"floating,afloat": ["floating_container","indicator_(description)"],
		...
		"football_team": ["group_(people)","ball","legs_and_feet"],
		...
		"four-leaf_clover": ["shamrock,clover","four_(digit),4","leaf"],
		"four_o'clock_eating_break": ["food","time","four_(digit),4"],
		"fox,jackal,coyote": ["dog,canine_(animal),canid","littleness,smallness","opening"],
		"France": ["country,state","grape(s)","gas","intensity"],
		...
		"French_(language)": ["language","grape(s)","gas","intensity"],
		...
		"French_horn,horn_(1)": ["trumpet,horn,cornet_(1)","rotation,circulation,orbit,lap,circle,round"],
		"French_horn,horn_(2)": ["brass_instrument","rotation,circulation,orbit,lap,circle,round"],
		...
		"Frey": ["Nordic_God,Nordic_Goddess","plant"],
		"Freya": ["Nordic_God,Nordic_Goddess","love,affection"],
		...
		"fuel_gauge": ["gauge,gage,meter","gasoline,gas,petrol"],
		...
		"game_box": ["digital_device","play,game_(in_combinations)"],
		...
		"gasoline,gas,petrol": ["water,fluid,liquid","wheel"],
		...
		"gauge,gage,meter": ["scale,measurement","indicator_(thing)"],
		...
		"get,acquire,receive-(to)": ["getting,acquiring,receiving","indicator_(action)"],
		...
		"give_birth-(to)": ["birth,giving_birth,parturition,delivery","indicator_(action)"],
		...
		"go_by_airplane,fly-(to)": ["ride,drive","indicator_(action)","airplane,aeroplane,plane"],
		...
		"gong": ["percussion_instrument","one_(digit),1","musical_note,music_(in_combinations)"],
		...
		"grape_juice": ["drink,beverage","grape(s)"],
		"grapefruit": ["orange,citrus_fruit","bigness,largeness"],
		"grasshopper": ["insect,bug","jump"],
		"grater,grinder": ["kitchen_tool,utensil","knife,sword","part,bit,piece,portion,part_of"],
		...
		"greeting,shalom,salam_(etc)": ["mouth","meeting_and_parting"],
		...
		"group_(people)": ["group_of,much_of,many_of,quantity_of","person,human_being,individual,human"],
		...
		"hair_accessory": ["thing,object","hair_(head)","attachment,appendix,annex"],
		"hair_drier,blow_dryer": ["tool,instrument","dryness,drought","hair"],
		"hair_pin,bobby_pin": ["thing,object","hair_(head)","linear_thing,pole"],
		"hair_spray": ["spray,vaporization","hair_(head)"],
		"hair_tie": ["thing,object","hair_(head)","ring"],
		"half_an_hour": ["three_(digit),3","zero_(digit),0","minute"],
		"hall": ["place,area,location,space","between","room"],
		"Halloween": ["day","ghost,phantom"],
		"Halloween_(OLD)": ["day","ghost_(OLD)"],
		...
		"handle,switch": ["thing,object","hand"],
		...
		"hard_rock": ["rock_music,rock'n'roll,rock","intensity"],
		...
		"herbivore": ["animal,beast","food","plant"],
		...
		"hidden_treasure,treasure_trove": ["jewel,gem,gemstone","secret"],
		...
		"hide_and_seek": ["play,game_(in_combinations)","hiding_place,cache"],
		"hiding_place,cache": ["place,area,location,space","secret"],
		"hierarchy": ["layer,level","plan,design,method,system"],
		...
		"honest,honestly": ["honesty","indicator_(description)"],
		"honesty": ["purpose","truth"],
		...
		"hot_tray,chafing_dish": ["tray","heat"],
		"hotel,motel": ["house,building,dwelling,residence","traveller"],
		"hour,o'clock": ["time","degree"],
		...
		"how-(question)": ["what,question_mark_(small)","activity,male_gender_(in_combinations)"],
		"how_much,how_many": ["what,question_mark_(small)","group_of,much_of,many_of,quantity_of"],
		"hug,cuddle,embrace-(to)": ["hug,squeeze,embrace","indicator_(action)"],
		"hug,squeeze,embrace": ["arm","around"],
		"huge": ["big,large","intensity"],
		"Hugin_and_Munin": ["two_(digit),2","bird","Nordic_God,Nordic_Goddess"],
		...
		"hyena": ["animal,beast","sound","up,upward","mouth"],
		"hygiene": ["activity,male_gender_(in_combinations)","protection,shelter","health"],
		"hygiene_(personal)": ["hygiene","person,human_being,individual,human"],
		...
		"I_need_more_time,give_me_time": ["need,require-(to)","time"],
		...
		"if": ["what,question_mark_(small)","either"],
		...
		"immoral,bad,wrong,morally_wrong": ["bad_conscience","indicator_(description)","intensity"],
		...
		"improve-(to)": ["cause","indicator_(action)","comparative_more","correctness,rightness"],
		"improvement": ["cause","comparative_more","correctness,rightness"],
		...
		"indigestion,heartburn": ["feeling,emotion,sensation","illness,disease,sickness_(sick_person)","organ,inner_organ,inner_body_part","food"],
		"indigo": ["colour","six_(digit),6"],
		"indoor,indoors": ["indoor_(character)","indicator_(description)"],
		"industry": ["generalization","factory,plant"],
		"inequality": ["different,other,difference","society"],
		...
		"influence": ["cause","change,alteration,conversion"],
		...
		"interdental_brush,interdental_rager": ["toothbrush","between"],
		...
		"interrogation": ["question","intensity"],
		...
		"invertebrate": ["animal,beast","minus,no,without","spine,backbone"],
		...
		"Ireland": ["country,state","shamrock,clover"],
		"iris_(eye)": ["cornea","light"],
		"Irish_(language)": ["language","shamrock,clover"],
		"iron": ["metal_bar","nail"],
		...
		"its": ["it,itself","belongs_to,of_(possessive)"],
		"Iyar": ["month","Israel"],
		...
		"jewel,gem,gemstone": ["stone,rock","star"],
		"jewelry,jewellery": ["generalization","jewel,gem,gemstone"],
		...
		"justification": ["support_(oral)","correctness,rightness"],
		"justified": ["justification","indicator_(description)"],
		"justify-(to)": ["justification","indicator_(action)"],
		...
		"karate": ["martial_arts","leg_and_foot"],
		...
		"key,tonality": ["stave,staff","musical_note,music_(in_combinations)"],
		...
		"kitchen_tongs": ["kitchen_tool,utensil","pliers,tongs,tweezer(s),pincer(s)_(pair_of)"],
		...
		"knitting_needle(s)": ["two_(digit),2","linear_thing,pole","cloth,fabric,material,textile,net"],
		...
		"labour": ["work,employment,job","birth,giving_birth,parturition,delivery"],
		"labyrinth,maze": ["place,area,location,space","difficulty","out_of,exit_(forward)"],
		"lacrosse_(sport)": ["tennis,racket_sport,racquet_sport","group_(people)"],
		"lacrosse_(sport)_(OLD)": ["tennis,racquet_sports_(OLD)","group_(people)"],
		"ladle": ["spoon","container,bowl,holder,pouch,basket"],
		"ladybird": ["beetle","spot,mark"],
		"Lag_B'Omer": ["night","comma","bonfire,barbeque,campfire"],
		"lake,pond": ["group_of,much_of,many_of,quantity_of","puddle,pool,water_(ground_level)"],
		"Lakshmi": ["God","money,cash"],
		"lamb": ["sheep","child,kid,youngster"],
		"lamb,mutton": ["food","sheep"],
		"lamb-(to)": ["birth,giving_birth,parturition,delivery","indicator_(action)","sheep"],
		...
		"language_development": ["development","language"],
		...
		"learn-(to)": ["getting,acquiring,receiving","indicator_(action)","knowledge,class_(in_combinations)"],
		...
		"leftovers,left_overs,food_waste_(food_thrown_away)": ["food","waste,garbage,rubbish,trash"],
		"leftovers,left_overs_(food_used_again)": ["food","again"],
		...
		"leprechaun": ["little_person","shamrock,clover"],
		...
		"lifetime,life-time,lifespan": ["time","life","all,every,everything,total,whole"],
		...
		"light_meter": ["gauge,gage,meter","light"],
		"light_switch": ["tool,instrument","cause","light"],
		"light_year": ["measurement,measure","light","year"],
		...
		"line,queue": ["line,stripe","group_(people)"],
		...
		"liquor_shop,liquor_store": ["store,shop","alcoholic_drink,alcoholic_beverage,liquor"],
		"list,inventory": ["paper,card,page","group_of,much_of,many_of,quantity_of","thing,object"],
		"literature": ["generalization","book"],
		...
		"Loki": ["Nordic_God,Nordic_Goddess","minus,no,without","truth"],
		"Loki_(OLD)": ["Nordic_God,Nordic_Goddess","lie_(OLD)"],
		...
		"longsighted,farsighted,presbyopic,hyperopic": ["longsightedness,farsightedness,presbyopia,hyperopia","indicator_(description)"],
		"longsightedness,farsightedness,presbyopia,hyperopia": ["limit(s),limitation,restriction","eye","nearness,closeness,proximity"],
		...
		"loss_(competition)": ["race,competition,contest","subtraction,loss"],
		"loss_(emotional)": ["feeling,emotion,sensation","subtraction,loss"],
		"lottery,game_of_chance": ["play,game_(in_combinations)","money,cash","number"],
		...
		"lynx,bobcat": ["cat,feline_(animal),felid","ear","hair"],
		...
		"make_compost-(to)": ["compost","indicator_(action)"],
		...
		"mammal": ["animal,beast","milk"],
		"man-made,produced": ["making,production,fashioning","indicator_(description)"],
		...
		"mandolin": ["guitar,string_instrument","man,male","blissymbol,Bliss-word"],
		...
		"matching_game": ["play,game_(in_combinations)","same,equal,equality"],
		...
		"mathematical_difficulty": ["difficulty","number"],
		...
		"member": ["person,human_being,individual,human","belongs_to,of_(possessive)","group_(people)"],
		"memo,reminder_note": ["paper,card,page","memory"],
		"memory_game,Kim's_game": ["play,game_(in_combinations)","memory"],
		...
		"metal_(music)": ["rock_music,rock'n'roll,rock","metal_bar"],
		...
		"mink": ["animal,beast","smell,odour","fur,coat_(animal),hair_(animal)"],
		"minute": ["time","apostrophe"],
		...
		"miss,lose-(to)": ["loss_(emotional)","indicator_(action)"],
		...
		"Mjolnir": ["hammer,gavel,mallet","Nordic_God,Nordic_Goddess"],
		"MMS": ["picture,image,icon,painting","telephone"],
		"mobile_phone,cellphone": ["telephone","portability"],
		"modem": ["thing,object","change,alteration,conversion","signal,broadcast,transmitting"],
		"modern": ["new","intensity"],
		"molasses,dark_syrup,black_treacle": ["flavouring,seasoning_(liquid)","up,upward","darkness"],
		"molecule": ["group_of,much_of,many_of,quantity_of","atom"],
		"mollusk(s),mollusc(s)": ["generalization","snail"],
		...
		"monster": ["creature,being","feeling,emotion,sensation","what,question_mark_(small)"],
		...
		"moon_axis": ["Earth_axis,axis","moon"],
		"moon_phase,phase_of_the_moon": ["limited_time,interval,period,awhile,for_a_while","moon"],
		"moose,elk": ["deer,cervine_(animal),cervid","bigness,largeness"],
		"moral,good,right,morally_right": ["good_conscience","indicator_(description)","intensity"],
		...
		"mosquito,gadfly,horsefly,cleg": ["fly,flying_insect","point,tip,peak"],
		"moss": ["plant","minus,no,without","root(s),rootage,root_system"],
		...
		"mountain_range": ["group_of,much_of,many_of,quantity_of","mountain"],
		"mountain_sports": ["sport","mountain"],
		"mourn-(to)": ["sadness,sorrow,unhappiness","indicator_(action)","subtraction,loss"],
		"mourning,grief": ["sadness,sorrow,unhappiness","subtraction,loss"],
		"mouse": ["rat,rodent,gnawer,gnawing_animal","littleness,smallness"],
		"mouse,pointing_device": ["tool,instrument","pointer_(hand)"],
		...
		"movie,action_film,action_movie,film_(action)": ["movie,film","activity,male_gender_(in_combinations)","quickness,rapidity,speediness"],
		"movie,film": ["cylinder,can","projector"],
		"movie,romance_movie,romance_film,film_(romantic)": ["movie,film","love,affection"],
		...
		"mummy_(general)": ["corpse,cadaver,carrion","cloth,fabric,material,textile,net"],
		...
		"music": ["ear","musical_note,music_(in_combinations)"],
		"music_therapist": ["therapist","music"],
		"musical": ["play_(theater)","musical_note,music_(in_combinations)"],
		"musical_group": ["group_of,much_of,many_of,quantity_of","musician"],
		"musical_instrument": ["tool,instrument","musical_note,music_(in_combinations)"],
		"musical_instrument_(with_many_strings)": ["musical_instrument_(in_combinations)","group_of,much_of,many_of,quantity_of","string"],
		"musician": ["person,human_being,individual,human","musical_note,music_(in_combinations)"],
		...
		"mustelid_(animal)": ["animal,beast","smell,odour","intensity"],
		...
		"navy": ["military,armed_forces,armed_services","puddle,pool,water_(ground_level)"],
		"near,almost,close,nearly": ["nearness,closeness,proximity","indicator_(description)"],
		"nearsighted,shortsighted,myopic": ["nearsightedness,shortsightedness,myopia","indicator_(description)"],
		"nearsightedness,shortsightedness,myopia": ["limit(s),limitation,restriction","eye","farness,remoteness,farawayness"],
		"necessary,necessarily,needed": ["need_(needy_person)","indicator_(description)"],
		"necklace": ["jewelry,jewellery","neck_(head)"],
		"need,require-(to)": ["need_(needy_person)","indicator_(action)"],
		...
		"net": ["cloth,fabric,material,textile,net","hand","getting,acquiring,receiving"],
		"Netherlands_(The),Holland": ["country,state","lowness,shortness_(height)"],
		"neurological": ["neuron","indicator_(description)"],
		...
		"nice,pleasant": ["feeling,emotion,sensation","indicator_(description)","correctness,rightness"],
		"niece": ["daughter","sibling(s)"],
		"niece_or_nephew": ["offspring,child","sibling(s)"],
		"nipple(s)": ["part,bit,piece,portion,part_of","breast(s)"],
		...
		"Nordic_God,Nordic_Goddess": ["God","north"],
		...
		"nuclear_energy": ["energy","nucleus_(atom)"],
		"nuclear_fallout,radioactive_dust": ["powder,dust","nucleus_(atom)"],
		"nuclear_fuel": ["fuel","nucleus_(atom)"],
		"nurse": ["police_officer,policeman,policewoman","medicine,medical_practice"],
		"nut": ["seed","tree"],
		"nutcracker": ["kitchen_tool,utensil","nut"],
		"nutrient,nutrition": ["substance","giving,gift","health"],
		...
		"odometer": ["gauge,gage,meter","farness,remoteness,farawayness"],
		"odometer_(OLD)": ["gauge,gage,meter","farness,remoteness,farawayness_(OLD)"],
		"oere_(currency)": ["part,bit,piece,portion,part_of","crown_(currency)"],
		"oesophagus,gullet": ["organ,inner_organ,inner_body_part","food","getting,acquiring,receiving","pipe,hose,tube_(2)"],
		"offer,sacrifice-(to)": ["giving,gift","indicator_(action)","Nordic_God,Nordic_Goddess"],
		...
		"oil_gauge": ["gauge,gage,meter","oil,lubricant"],
		...
		"old_(opposite_new)": ["opposite_meaning,opposite_of,opposite","new"],
		...
		"omnivore": ["animal,beast","food","animal,beast","plant"],
		"once": ["one_(digit),1","time","indicator_(description)"],
		"once_upon_a_time": ["one_(digit),1","time","past"],
		...
		"online_game,multiplayer_game,network_game": ["digital_game,video_game,computer_game","cloth,fabric,material,textile,net"],
		...
		"orbit_of_the_moon": ["rotation,circulation,orbit,lap,circle,round","moon"],
		"orchard": ["grove","fruit"],
		...
		"oval,ellipse_(shape)": ["shape,form","oval"],
		"oval,elliptic,elliptical": ["oval,ellipse_(shape)","indicator_(description)"],
		...
		"ox": ["animal_(bovine,ovine),bovid,bovine","work,employment,job"],
		...
		"paralysis,palsy": ["limit(s),limitation,restriction","activity,male_gender_(in_combinations)","muscle"],
		"parasailing": ["parachuting","boat,ship"],
		"paraskiing": ["parachuting","skis_(pair_of)"],
		"paratrooper": ["soldier,warrior","from_sky"],
		"pardon,what_did_you_say": ["what,question_mark_(small)","say,speak,talk,tell,express-(to)"],
		...
		"patient_(in_medical_care)": ["person,human_being,individual,human","getting,acquiring,receiving","medicine,medical_practice"],
		...
		"people,tribe,clan,folk": ["group_(people)","view_of_life"],
		...
		"perch_(fish)": ["fish_(animal)","quill(s),spine(s)"],
		...
		"period_of_life": ["limited_time,interval,period,awhile,for_a_while","life"],
		...
		"pick-(to)": ["finger","indicator_(action)","getting,acquiring,receiving"],
		...
		"pinch,pincer_grip": ["finger","pliers,tongs,tweezer(s),pincer(s)_(pair_of)"],
		"pinch,pluck,tweeze-(to)": ["pinch,pincer_grip","indicator_(action)"],
		...
		"plant-book,dictionary_of_plants": ["book","plant"],
		...
		"plastic_bag": ["sack,bag","material,raw_material,stuff","chemical_product"],
		"play,game_(in_combinations)": ["activity,male_gender_(in_combinations)","feeling,emotion,sensation"],
		...
		"plough_(ancient),ard,ard_plough,scratch_plough": ["plough","past"],
		...
		"point,indicate-(to)": ["pointer_(hand)","indicator_(action)"],
		...
		"possibility": ["existence,being_(2)","what,question_mark_(small)"],
		...
		"practice,drill,exercise,rehearsal": ["work,employment,job","repetition,copying,duplication,replication"],
		...
		"premature_birth": ["birth,giving_birth,parturition,delivery","before,in_front_of,prior_to","time"],
		...
		"pressure_gauge": ["gauge,gage,meter","pressure"],
		...
		"privy,outhouse": ["place,area,location,space","bowel_movement,defecation,shitting,feces,shit,poop"],
		...
		"protestantism": ["Christianity","group_(people)"],
		"protractor": ["gauge,gage,meter","angle"],
		...
		"public_(the_public)": ["group_of,much_of,many_of,quantity_of","group_(people)"],
		...
		"quarrel,row": ["activity,male_gender_(in_combinations)","gathering,assembly,meeting,conference","not,negative,no,don't,doesn't"],
		...
		"rabies": ["illness,disease,sickness_(sick_person)","animal,beast","comma","teeth"],
		...
		"rag": ["cloth,fabric,material,textile,net","break,fracture,damage"],
		...
		"rain_gauge": ["gauge,gage,meter","rain"],
		...
		"raisin(s),currant(s)": ["grape(s)","dryness,drought"],
		"raisins_(OLD)": ["grape(s)","opposite_meaning,opposite_of,opposite","water,fluid,liquid"],
		"rake": ["comb","garden"],
		...
		"rapid(s)": ["river,stream,current","intensity","stone,rock"],
		...
		"reading_difficulty": ["difficulty","reading"],
		...
		"realize,realise-(to)": ["understanding,comprehension","lightning"],
		"receipt": ["paper,card,page","after,behind","money,cash"],
		"receiver": ["getting,acquiring,receiving","indicator_(thing)"],
		...
		"record_(achievement)": ["outcome,result","superlative_most"],
		...
		"rectangle,oblong_(shape)": ["shape,form","card"],
		"rectangular,oblong": ["rectangle,oblong_(shape)","indicator_(description)"],
		"rectum": ["intestine(s),bowel(s),gut(s)","waste,garbage,rubbish,trash"],
		"recumbent_bicycle": ["bicycle","reclining,lying_(person_lying_down)"],
		"recycling_station": ["place,area,location,space","waste_sorting,garbage_sorting,source_separation_(of_waste)"],
		...
		"referee,judge_(sport)": ["person,human_being,individual,human","decision","sport"],
		"referee_(football,soccer)": ["person,human_being,individual,human","decision","ball","legs_and_feet"],
		...
		"regain,recover,retrieve-(to)": ["get,acquire,receive-(to)","again"],
		...
		"rent,lease,let-(to)": ["getting,acquiring,receiving","indicator_(action)","money,cash","limited_time,interval,period,awhile,for_a_while"],
		...
		"residential_institution,group_home,hostel,residential_home": ["house,building,dwelling,residence","group_(people)"],
		...
		"reuse,recycling": ["usage,use","again"],
		"reuse,use_again,recycle-(to)": ["reuse,recycling"],
		"revelry,revel": ["party,festival","intensity"],
		...
		"road_sign,traffic_signal": ["sign,signal","vehicle,carriage,railway_car"],
		...
		"rock_music,rock'n'roll,rock": ["music","up_and_down"],
		...
		"rot,decompose-(to)": ["rot,decomposition,rotting_matter","indicator_(action)"],
		"rot,decomposition,rotting_matter": ["change,alteration,conversion","organism","deletion,cancellation,destruction"],
		...
		"rotten,decomposed": ["rot,decomposition,rotting_matter","indicator_(description)"],
		"rouge,blusher": ["colour","and,also,plus,too","cheek"],
		"rough_sea": ["group_of,much_of,many_of,quantity_of","wave"],
		"round,circular": ["circle_(shape)","indicator_(description)"],
		"router": ["connector,interface_box","signal,broadcast,transmitting"],
		"rowdy,raucous": ["quarrel,row","indicator_(description)"],
		...
		"rub,scrub-(to)": ["hand","indicator_(action)","back_and_forth,backward_and_forward,to_and_fro","intensity"],
		"rubber_boat,dinghy": ["boat,ship","air,atmosphere"],
		"rug,carpet,mat": ["cloth,fabric,material,textile,net","floor_covering,linoleum"],
		"rugby,football_(N.A.)": ["sport","rugby_ball,football_(N.A.)","legs_and_feet"],
		...
		"run,jog": ["activity,male_gender_(in_combinations)","legs_and_feet","forward","intensity"],
		"run,jog-(to)": ["legs_and_feet","indicator_(action)","quickness,rapidity,speediness"],
		...
		"sacrifice": ["gift,offering,present","Nordic_God,Nordic_Goddess"],
		...
		"Saehrimnir": ["pig","Nordic_God,Nordic_Goddess"],
		...
		"sailboard,windsurf_board,windsurfing_board": ["board","sail"],
		...
		"salt": ["flavouring,condiment,seasoning","crystal"],
		"salt_(OLD)": ["flavouring,condiment,seasoning","ocean,sea"],
		"salt_crystal": ["crystal","ocean,sea"],
		"saltwater,seawater": ["water,fluid,liquid","crystal"],
		"salty": ["taste","indicator_(description)","crystal"],
		"salty_(OLD)": ["taste","indicator_(description)","ocean,sea"],
		...
		"sand_play": ["play,game_(in_combinations)","sand"],
		...
		"scale_(weighing)": ["gauge,gage,meter","weight"],
		...
		"scavenger,carrion_eater": ["animal,beast","food","death"],
		"scenery,landscape": ["generalization","countryside,country,nature"],
		...
		"school_year": ["year","school_(in_combinations)"],
		...
		"sea_chart": ["paper,card,page","puddle,pool,water_(ground_level)"],
		"sea_cucumber": ["water_creature","oval"],
		"sea_lion": ["dolphin,porpoise,water_mammal_(with_tail)","mouth","intensity"],
		"sea_urchin": ["water_creature","quill(s),spine(s)"],
		"seaplane": ["airplane,aeroplane,plane","puddle,pool,water_(ground_level)"],
		...
		"second_(time)": ["time","apostrophe","apostrophe"],
		...
		"seem-(to)": ["state_of_mind","indicator_(action)","what,question_mark_(small)"],
		...
		"selfie": ["photograph,photo,pic","self,oneself,ego_(person)"],
		...
		"server,host_(computer)": ["computer","combination,connection"],
		...
		"sexual_arousal,sexual_excitement": ["excitement","gender,sex"],
		...
		"sheep": ["animal_(bovine,ovine),bovid,bovine","cloth,fabric,material,textile,net"],
		...
		"shellfish": ["generalization","oyster,clam,mussel"],
		...
		"shipping_forecast": ["weather_forecast","puddle,pool,water_(ground_level)"],
		...
		"sign_(OLD)": ["pointer_(hand)","thing,object"],
		...
		"signal_reception": ["getting,acquiring,receiving","signal,broadcast,transmitting"],
		"signal_strength_meter": ["gauge,gage,meter","signal,broadcast,transmitting"],
		...
		"sleeve(s)": ["clothing,clothes,garment","arm"],
		"Sleipnir": ["horse","Nordic_God,Nordic_Goddess"],
		...
		"sloping,sloped,slanting,slanted": ["downward_and_forward","indicator_(description)"],
		...
		"smash,grind,shatter,splinter-(to)": ["break,fracture,damage","indicator_(action)","group_of,much_of,many_of,quantity_of","part,bit,piece,portion,part_of"],
		...
		"sociology": ["biology","group_(people)"],
		...
		"somersault_(person)": ["somersault","person,human_being,individual,human"],
		"sometimes": ["part,bit,piece,portion,part_of","time","indicator_(description)"],
		"son-in-law": ["husband","offspring,child"],
		"song": ["mouth","musical_note,music_(in_combinations)"],
		...
		"sort,differentiate,separate,classify-(to)": ["type,kind,sort","indicator_(action)"],
		"sort_garbage,separate_waste-(to)": ["waste_sorting,garbage_sorting,source_separation_(of_waste)","indicator_(action)"],
		"soul": ["spirit","person,human_being,individual,human"],
		"sound-(to)": ["sound","indicator_(action)"],
		"sound_recorder,tape_recorder": ["machine,appliance,engine,motor","repetition,copying,duplication,replication","ear"],
		...
		"speech_(event)": ["mouth","event,happening,occasion","group_(people)"],
		...
		"speedometer": ["gauge,gage,meter","quickness,rapidity,speediness"],
		...
		"spine,backbone": ["bone","back_(body)"],
		...
		"sports_glove,glove,mitt": ["glove(s),mitt(s),mitten(s)","getting,acquiring,receiving"],
		"spot,mark": ["eye","dot"],
		...
		"spring_(water)": ["puddle,pool,water_(ground_level)","up,upward"],
		"springbok": ["animal_(bovine,ovine),bovid,bovine","jump"],
		...
		"steep": ["sloping,sloped,slanting,slanted","intensity"],
		...
		"stone_(material)": ["material,raw_material,stuff","stone,rock"],
		...
		"strange": ["feeling,emotion,sensation","indicator_(description)","what,question_mark_(small)"],
		"stranger": ["person,human_being,individual,human","feeling,emotion,sensation","what,question_mark_(small)"],
		...
		"stream_(digital),data_stream": ["river,stream,current","digits_(computer)"],
		"stream_(digital_data)-(to)": ["stream_(digital),data_stream","indicator_(action)"],
		"streamed,streaming_(digital_data)": ["stream_(digital),data_stream","indicator_(description)"],
		...
		"student,pupil": ["person,human_being,individual,human","getting,acquiring,receiving","knowledge,class_(in_combinations)"],
		"study-(to)": ["activity,male_gender_(in_combinations)","indicator_(action)","getting,acquiring,receiving","knowledge,class_(in_combinations)"],
		...
		"submerged_rock,reef": ["stone,rock","under,below,inferior","puddle,pool,water_(ground_level)"],
		...
		"supporters,cheering_section": ["group_(people)","cheering_(the_sound)"],
		"surfboard": ["board","wave"],
		"surgeon": ["doctor,physician","knife,sword"],
		"surprise": ["feeling,emotion,sensation","what,question_mark_(small)","intensity"],
		...
		"suspender(s)": ["linear_thing,pole","up,upward","clothing,clothes,garment"],
		...
		"sweaty,sweating,perspiring": ["sweat,perspiration","indicator_(description)"],
		...
		"switch-(to)": ["handle,switch","indicator_(action)"],
		"switch_off,turn_off-(to)": ["handle,switch","indicator_(action)","minus,no,without"],
		"switch_on,turn_on-(to)": ["handle,switch","indicator_(action)","and,also,plus,too"],
		"Switzerland": ["country,state","clock,timepiece"],
		"swordfish": ["fish_(animal)","knife,sword"],
		"symbol_display,symbol_board,symbol_chart": ["paper,card,page","and,also,plus,too","blissymbol,Bliss-word"],
		...
		"tasteless,not_tasty,not_good": ["taste","indicator_(description)","not,negative,no,don't,doesn't"],
		...
		"tax_(national,federal)": ["tax","country,state"],
		...
		"team": ["group_(people)","teamwork"],
		"team_(sport)": ["group_(people)","sport"],
		...
		"tennis,racquet_sports_(OLD)": ["sport","crossed_racquets_(OLD)"],
		"tennis_(activity)": ["activity,male_gender_(in_combinations)","racket,racquet"],
		"tennis_(activity)_(OLD)": ["activity,male_gender_(in_combinations)","crossed_racquets_(OLD)"],
		"tent": ["house,building,dwelling,residence","cloth,fabric,material,textile,net"],
		"term,semester": ["season","school_(in_combinations)"],
		"termite,wood_destroying_insect": ["insect,bug","tree_or_wood_destruction"],
		...
		"theft": ["getting,acquiring,receiving","not,negative,no,don't,doesn't"],
		...
		"they,them,themselves-(indefinite)": ["it,itself","indicator_(plural)"],
		...
		"this_week": ["week","now"],
		"this_year": ["year","now"],
		"Thor": ["Nordic_God,Nordic_Goddess","hammer,gavel,mallet"],
		...
		"throat_(inside)": ["neck_(head)","in,inside,interior,internal"],
		...
		"toothpick": ["linear_thing,pole","teeth"],
		...
		"translation": ["bridge,overpass","language"],
		"transvestite_(female)": ["woman,female","clothing,clothes,garment","man,male"],
		"transvestite_(male)": ["man,male","dress"],
		"trap": ["thing,object","getting,acquiring,receiving","intensity","plan,design,method,system"],
		...
		"tremor,shudder": ["activity,male_gender_(in_combinations)","muscle","back_and_forth,backward_and_forward,to_and_fro"],
		...
		"tune,melody": ["plan,design,method,system","musical_note,music_(in_combinations)"],
		"tuning_fork": ["fork","musical_note,music_(in_combinations)"],
		...
		"Tyr": ["Nordic_God,Nordic_Goddess","war"],
		...
		"umami": ["taste","seaweed"],
		"umami_tasting": ["umami","indicator_(description)"],
		...
		"unconscious,comatose": ["mind,intellect,reason","minus,no,without","activity,male_gender_(in_combinations)"],
		"unconsciousness,coma,comatoseness": ["unconscious,comatose","indicator_(description)"],
		"underground,below_ground": ["under_(ground_level)","indicator_(description)"],
		...
		"unending,endless": ["minus,no,without","at_one's_destination,there"],
		"unfair,unjust": ["minus,no,without","just,fair"],
		"unfinished": ["minus,no,without","finished,complete,completed,done,all_done"],
		...
		"unicycle,monocycle,one-wheeled_vehicle": ["one_(digit),1","wheel"],
		"unicycle,ride_a_one-wheeled_vehicle-(to)": ["unicycle,monocycle,one-wheeled_vehicle","indicator_(action)"],
		...
		"unit,example,sample,for_example,e.g.": ["one_(digit),1","indicator_(thing)"],
		...
		"Valhalla": ["house,building,dwelling,residence","Nordic_God,Nordic_Goddess"],
		"vampire": ["make-believe_person,imaginary_person","blood"],
		"van,minibus": ["bus,coach","littleness,smallness"],
		"vanilla": ["flavouring,condiment,seasoning","pod,seedcase,seedpod"],
		"vanilla_(liquid)": ["flavouring,seasoning_(liquid)","pod,seedcase,seedpod"],
		"vanilla_(powder)": ["flavouring,seasoning_(powder)","pod,seedcase,seedpod"],
		"vanilla_sauce": ["sauce,gravy,relish,dressing","pod,seedcase,seedpod"],
		...
		"vegetarian_(food)": ["food","indicator_(description)","plant"],
		"vegetarian_(person)": ["person,human_being,individual,human","food","plant"],
		...
		"vertebrate": ["animal,beast","spine,backbone"],
		...
		"visible,sighted": ["eye","indicator_(description)"],
		...
		"voltmeter": ["gauge,gage,meter","voltage"],
		...
		"walk,walking": ["activity,male_gender_(in_combinations)","legs_and_feet"],
		"walk_(horse)-(to)": ["horse","indicator_(action)"],
		"walker,walking_aid_(1)": ["aid,device,support","activity,male_gender_(in_combinations)","legs_and_feet"],
		"walker,walking_aid_(2)": ["medical_aid","legs_and_feet"],
		...
		"walrus": ["dolphin,porpoise,water_mammal_(with_tail)","teeth"],
		...
		"waste_sorting,garbage_sorting,source_separation_(of_waste)": ["type,kind,sort","waste,garbage,rubbish,trash"],
		...
		"water_meter": ["gauge,gage,meter","water,fluid,liquid"],
		"water_play": ["play,game_(in_combinations)","water,fluid,liquid"],
		"water_polo": ["ball_sports","water,fluid,liquid"],
		"water_ski": ["ski,runner_(sled_etc)","puddle,pool,water_(ground_level)"],
		...
		"website,domain_name,homepage,internet_domain": ["name,label,term,title","place,area,location,space","digital_world"],
		...
		"whale": ["dolphin,porpoise,water_mammal_(with_tail)","bigness,largeness"],
		"what": ["who,that,which-(relative)","thing,object"],
		"what_(thing)-(question)": ["what,question_mark_(small)","thing,object"],
		"what_kind-(question)": ["what,question_mark_(small)","type,kind,sort"],
		...
		"when,what_time-(question)": ["what,question_mark_(small)","time"],
		"which,that-(relative)": ["who,that,which-(relative)","part,bit,piece,portion,part_of"],
		"which-(question)": ["what,question_mark_(small)","part,bit,piece,portion,part_of"],
		"whipping_knot": ["spiral","strap,string,velcro,rope,cord"],
		"whisk,beater": ["kitchen_tool,utensil","mixture"],
		...
		"who,whom-(question)": ["what,question_mark_(small)","person,human_being,individual,human"],
		...
		"why-(question)": ["what,question_mark_(small)","therefore,so,so_that"],
		...
		"wilderness": ["countryside,country,nature","opening"],
		...
		"wind_surfing": ["sport","sailboard,windsurf_board,windsurfing_board"],
		"wind_turbine": ["windmill","electricity"],
		"windmill": ["tower","propeller,rotor_(blades)"],
		"wine": ["alcoholic_drink,alcoholic_beverage,liquor","grape(s)"],
		...
		"wireless_connection,WiFi,Bluetooth_(etc)": ["digital_signal","minus,no,without","linear_thing,pole"],
		...
		"Woden": ["Nordic_God,Nordic_Goddess","eye"],
		...
		"wonder,inquire,enquire,be_curious-(to)": ["curiosity,curiousness,inquisitiveness,wonder","indicator_(action)"],
		...
		"wound,cut,sore": ["break,fracture,damage","skin"],
		...
		"writing_difficulty": ["difficulty","pen,pencil"],
		"X-ray": ["light","through","thing,object"],
		"X-ray-(to)": ["X-ray","indicator_(action)"],
		...
		"yarn": ["thread,string,cord","cloth,fabric,material,textile,net"],
